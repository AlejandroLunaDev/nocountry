      ...
      <main className="container mx-auto py-8 px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-400 mt-2">Vista detallada en formato lista de los miembros del equipo</p>
          </div>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="bg-[#050A1A] rounded-lg border border-[#1A2035] overflow-hidden">
                    <div className="grid grid-cols-12 gap-4 p-4 border-b border-[#1A2035] bg-[#0A1428]">
                      ...
                      <div className="col-span-1 font-medium text-center">Mensajes</div>
                      <div className="col-span-1 font-medium text-center">Participación</div>
                      <div className="col-span-1 font-medium text-center">Asistencia</div>
                      <div className="col-span-1 font-medium text-center">Acciones</div>
                    </div>
                        ...
                        >
                          <div className="col-span-4 flex items-center gap-3">
                            <Avatar className="h-10 w-10 border border-[#1A2035]">
                              ...
                              <AvatarFallback className="bg-[#1A2035]">{member.name.charAt(0)}</AvatarFallback>
                            </Avatar>
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1 mt-1">
                                ...
                                {member.skills.length > 2 && (
                                  <Badge variant="outline" className="bg-[#1A2035] border-none text-xs py-0 px-1">
                                    +{member.skills.length - 2}
                                  </Badge>
                                )}
                              </div>
                          ...
                          <div className="col-span-2 flex items-center">
                            <span className="text-[#FF2D8A]">{member.role}</span>
                          </div>
                          <div className="col-span-2 flex items-center text-sm text-gray-400">{member.location}</div>
                          ...
                          <div className="col-span-1 flex flex-col items-center justify-center">
                            ...
                            <Progress value={member.stats.participation} className="h-1 w-12 mt-1 bg-[#1A2035]">
                              <div className="h-full bg-[#00D1FF]" />
                            </Progress>
                          </div>
                          <div className="col-span-1 flex flex-col items-center justify-center">
                            <span className="font-medium">{member.stats.attendance}%</span>
                            <Progress value={member.stats.attendance} className="h-1 w-12 mt-1 bg-[#1A2035]">
