    ...
    <header className="border-b border-[#1A2035] p-4 sticky top-0 z-10 bg-[#050A1A]/80 backdrop-blur-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link href="/" className="text-white hover:text-[#FF2D8A] transition-colors">
            Simulación Laboral
          </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 bg-[#0A1428] border-[#1A2035] text-white" align="end" forceMount>
